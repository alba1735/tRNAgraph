...
def graph(
    ...
    with usage_error_guard(), handle_output(quiet, tool="graph", destination=output_path, name_suffix=_log_suffix(anndata, variant)):
        ...
        args = SimpleNamespace(
            ...
            clusteroverview=clusteroverview, clusternumeric=clusternumeric, clustermask=clustermask,
            corrmethod=corrmethod, corrgroup=corrgroup, corrmask=corrmask, covgrp=covgrp, covobs=covobs, covtype=covtype,
